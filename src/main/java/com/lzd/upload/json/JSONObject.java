...
public class JSONObject extends LinkedHashMap<String, Object>
{
    ...
    public static Object transfer(final Object value)
    {
    ...
    public static JSONArray toArr(final Collection<Object> list)
    {
     ...
     */
    public static JSONArray arrayAt(JSONArray arr, int index)
    {
        expand(arr, index);
     ...
     */
    public static JSONObject objAt(final JSONArray arr, int index)
    {
        expand(arr, index);
        if (arr.get(index) == null)
        {
     ...
     * @param value 值。
     */
    public static void elementAt(final JSONArray arr, final int index, final Object value)
    {
     ...
     * @return 值。
     */
    public static Object elementAt(final JSONArray arr, final int index)
    {
     ...
     * @return 返回传入的数组
     */
    public static JSONArray expand(final JSONArray arr, final int index)
    {
     ...
     * @return 返回回调函数的返回值。
     */
    public <T> T endArray(final String name, final String indexesStr, final EndArrayCallback<T> callback)
    {
    ...
    public static int[] parseIndexes(final String s)
    {
        int[] indexes = null;
